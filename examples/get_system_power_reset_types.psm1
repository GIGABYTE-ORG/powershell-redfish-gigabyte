###
#
# Lenovo Redfish examples - Get system reset types
# Copyright Notice:
#
...
function get_system_power_reset_types
{
    <#
   .Synopsis
    Cmdlet used to Get system reset types
   .DESCRIPTION
    Cmdlet used to Get system reset types from BMC using Redfish API. Information will be printed to the screen. Connection information can be specified via command parameter or configuration file.
