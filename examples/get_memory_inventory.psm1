...
function get_memory_inventory
{
    <#
   .Synopsis
    Cmdlet used to get memory inventory
   .DESCRIPTION
    Cmdlet used to get memory inventory from BMC using Redfish API. system info will be printed to the screen. Connection information can be specified via command parameter or configuration file.
   ...
   .EXAMPLE
    get_memory_inventory -ip 10.10.10.10 -username USERID -password PASSW0RD
   #>
