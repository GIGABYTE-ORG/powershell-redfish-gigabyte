###
#
# Lenovo Redfish examples - Get server boot once
# Copyright Notice:
#
...
function get_server_boot_once
{
    <#
   .Synopsis
    Cmdlet used to Get server boot once
   .DESCRIPTION
   ...
   .EXAMPLE
    get_server_boot_once -ip 10.10.10.10 -username USERID -password PASSW0RD 
   #>
